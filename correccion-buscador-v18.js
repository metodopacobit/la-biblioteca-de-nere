...
(function () {
    ...
    function tokenCoincideV18Nere(tokenBuscado, tokenCandidato) {
        ...
        /*
           Solo se permite completar una palabra cuando el usuario
           ha escrito al menos 4 letras.

           De este modo:
           - "beng" sí puede encontrar "Bengoa".
           - "goa" NO encuentra "Bengoa", "Ngoa" ni "Goaz".
        */
        return (
    ...
    window.puntuacionRegistroCasaNere = function (
        ...
        /* El título siempre tiene prioridad en la búsqueda general. */
        if (campo !== "autor") {
        ...
        /*
           El autor solo entra si la palabra coincide como palabra real
           o como prefijo de 4 letras o más. Nunca por un trozo interno.
        */
        if (campo !== "titulo") {
    ...
    /* =================================================
       FILTRO "TODO" COMO ESTADO SEGURO POR DEFECTO
    ================================================= */
    ...
    /* Al entrar en Buscar, siempre empieza en búsqueda general. */
    envolverFuncionV18Nere(
        "abrirBuscar",
        activarFiltroTodoV18Nere
    );

    /* Al cambiar de catálogo se evita conservar por error "Autor". */
    envolverFuncionV18Nere(
    ...
    /*
       Si el navegador restauró la pantalla de resultados desde memoria,
       se repite la búsqueda una sola vez con el filtro correcto.
    */
    setTimeout(() => {
