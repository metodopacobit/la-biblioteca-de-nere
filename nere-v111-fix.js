...
(function () {
  ...
  const MARCADORES = {
    pt: {
      fuertes: ["nao","uma","sob","redoma","novembro","janeiro","fevereiro","outubro","justica","livro","livros","milagre","justiceiros","portugues","edicao","coracao","criancas","voce","tambem","morto","tiros","homem","mulher","menina","menino","cidade","tempo","depois","antes","ainda","morte","vida"],
      comunes: ["do","da","dos","das","em","no","na","nos","nas","ao","aos","pela","pelo","pelos","pelas","seu","sua","meu","minha","nossa","mais"]
    },
    ca: {
      fuertes: ["llibre","llibres","lloba","blanc","cicatriu","catala","edicio","aquest","aquesta","aixo","avui","perque","meva","teva","seva","anys","rei","crema","nen","nena","dona","home","ciutat"],
      comunes: ["amb","sense","dels","dalt","baix","mes","els"]
    },
    en: {
      fuertes: ["english","edition","novel","book","books","stories","story","fairy","tale","queen","wolf","everything","burns","under","dome","secret","secrets","world","girl","boy","city"],
    ...
    it: {
      fuertes: ["italiana","edizione","libro","storia","regina","rossa","lupo","favola","brucia","ragazza","ragazzo","citta"],
